...
def functional(filename):
    ...
    def decode(instruction):
        ...
        opcode = Bits(bin=instruction[:8]) # Get the final 6 bits of the instruction
        print 'opcode: ', opcode, '\n'
        if opcode == Bits(bin='000000') or opcode == 0b000010 or opcode == 0b000100 or \
        ...
        if opcode == 0b001110 or opcode == 0b0011111 or opcode == BitArray('0x04') or \
           opcode == 0b010001:
            rs = Bits(bin=instruction[6:11])#(instruction >> 21) & 0b00000011111
            rt = Bits(bin=instruction[12:17])#(instruction >> 16) & 0b0000000000011111 

...
class simulator():
    ...
    # EXE
    def EXE(self, stage):
        if stage.get_name_op() == 'r_type':
            self.exe_r_type(stage)
        elif stage.get_name_op() == 'i_type':
            self.exe_i_type(stage)
        elif stage.get_name_op() == 'control_flow':
    ...
    def exe_i_type(self, stage):
        ...
        # LDW
            ...
            stage.set_ALU_result(int(self.lines[int((self.R[rs] + imm)/4)],16))
        ...
        # STW
            ...
            stage.set_ALU_result(self.R[rt])
    ...
    def MEM(self, stage):
        if stage.get_name_op() == 'ldw':
            # load value of addressing store in self.R[self.rs] + imm is the base into self.R[self.rt]
            #stage.set_ALU_result(int(self.lines[int((self.R[stage.get_rs()] + stage.get_imm())/4)],16))
        ...
        # STW
            ...
            #self.lines[int((self.R[stage.get_rs()] + stage.get_imm())/4)] = stage.get_ALU_result()#self.R[rt]
            if self.show_instruction:
